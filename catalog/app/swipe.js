import { renderTagEditor, effectiveKind } from './tag-edits.js?v=470d4f8b31';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=470d4f8b31';
import { renderCommentBox } from './comments.js?v=470d4f8b31';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=470d4f8b31';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=470d4f8b31'));
