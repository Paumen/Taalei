import { renderTagEditor, effectiveKind } from './tag-edits.js?v=38ec64ef54';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=38ec64ef54';
import { renderCommentBox } from './comments.js?v=38ec64ef54';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=38ec64ef54';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=38ec64ef54'));
