import { renderTagEditor, effectiveKind } from './tag-edits.js?v=5ebe1d7413';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=5ebe1d7413';
import { renderCommentBox } from './comments.js?v=5ebe1d7413';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=5ebe1d7413';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=5ebe1d7413'));
