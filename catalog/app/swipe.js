import { renderTagEditor, effectiveKind } from './tag-edits.js?v=4cab552b90';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=4cab552b90';
import { renderCommentBox } from './comments.js?v=4cab552b90';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=4cab552b90';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=4cab552b90'));
