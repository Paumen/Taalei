import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b1939ff762';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b1939ff762';
import { renderCommentBox } from './comments.js?v=b1939ff762';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b1939ff762';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b1939ff762'));
