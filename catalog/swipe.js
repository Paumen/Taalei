import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b83fb1c272';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b83fb1c272';
import { renderCommentBox } from './comments.js?v=b83fb1c272';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b83fb1c272';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b83fb1c272'));
