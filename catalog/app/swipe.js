import { renderTagEditor, effectiveKind } from './tag-edits.js?v=cf75c71b96';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=cf75c71b96';
import { renderCommentBox } from './comments.js?v=cf75c71b96';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=cf75c71b96';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=cf75c71b96'));
