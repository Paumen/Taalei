import { renderTagEditor, effectiveKind } from './tag-edits.js?v=07a5c94453';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=07a5c94453';
import { renderCommentBox } from './comments.js?v=07a5c94453';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=07a5c94453';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=07a5c94453'));
