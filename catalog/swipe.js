import { renderTagEditor, effectiveKind } from './tag-edits.js?v=c749319281';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=c749319281';
import { renderCommentBox } from './comments.js?v=c749319281';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=c749319281';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=c749319281'));
