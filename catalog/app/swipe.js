import { renderTagEditor, effectiveKind } from './tag-edits.js?v=502e9610b9';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=502e9610b9';
import { renderCommentBox } from './comments.js?v=502e9610b9';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=502e9610b9';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=502e9610b9'));
