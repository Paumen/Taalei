import { renderTagEditor, effectiveKind } from './tag-edits.js?v=d6d9aac561';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=d6d9aac561';
import { renderCommentBox } from './comments.js?v=d6d9aac561';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=d6d9aac561';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=d6d9aac561'));
