import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b1dd60f631';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b1dd60f631';
import { renderCommentBox } from './comments.js?v=b1dd60f631';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b1dd60f631';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b1dd60f631'));
