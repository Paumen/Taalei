import { renderTagEditor, effectiveKind } from './tag-edits.js?v=47b8476f94';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=47b8476f94';
import { renderCommentBox } from './comments.js?v=47b8476f94';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=47b8476f94';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=47b8476f94'));
