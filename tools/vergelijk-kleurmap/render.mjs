 ...
 * kits nu dragen en met het voorstel colormap-v2.png, en schrijft de bladen weg
 ...
 *
 * Het voorstel komt in beeld zonder de kits aan te raken: elk verzoek onder
...
const VOORSTEL = path.join(HIER, 'colormap-v2.png');
