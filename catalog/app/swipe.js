import { renderTagEditor, effectiveKind } from './tag-edits.js?v=62fe90aa92';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=62fe90aa92';
import { renderCommentBox } from './comments.js?v=62fe90aa92';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=62fe90aa92';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=62fe90aa92'));
