import { renderTagEditor, effectiveKind } from './tag-edits.js?v=89e3649ea9';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=89e3649ea9';
import { renderCommentBox } from './comments.js?v=89e3649ea9';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=89e3649ea9';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=89e3649ea9'));
