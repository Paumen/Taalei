import { renderTagEditor, effectiveKind } from './tag-edits.js?v=c166a81268';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=c166a81268';
import { renderCommentBox } from './comments.js?v=c166a81268';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=c166a81268';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=c166a81268'));
