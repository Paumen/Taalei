import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=d8d415bdaa';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=d8d415bdaa';
import { colorSwatches, setBands } from './color-edits.js?v=d8d415bdaa';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=d8d415bdaa';
import { mountExtractBar, setPageParts } from './extract.js?v=d8d415bdaa';
import './bouwstempel.js?v=d8d415bdaa';
