import { renderTagEditor, effectiveKind } from './tag-edits.js?v=192aa3d259';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=192aa3d259';
import { renderCommentBox } from './comments.js?v=192aa3d259';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=192aa3d259';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=192aa3d259'));
