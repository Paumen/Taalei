import { renderTagEditor, effectiveKind } from './tag-edits.js?v=35ce522f2e';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=35ce522f2e';
import { renderCommentBox } from './comments.js?v=35ce522f2e';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=35ce522f2e';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=35ce522f2e'));
