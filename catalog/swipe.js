import { renderTagEditor, effectiveKind } from './tag-edits.js?v=751c532b42';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=751c532b42';
import { renderCommentBox } from './comments.js?v=751c532b42';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=751c532b42';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=751c532b42'));
