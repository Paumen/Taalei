import { renderTagEditor, effectiveKind } from './tag-edits.js?v=ecbb7df350';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=ecbb7df350';
import { renderCommentBox } from './comments.js?v=ecbb7df350';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=ecbb7df350';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=ecbb7df350'));
