import { renderTagEditor, effectiveKind } from './tag-edits.js?v=8a3fe7a2b2';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=8a3fe7a2b2';
import { renderCommentBox } from './comments.js?v=8a3fe7a2b2';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=8a3fe7a2b2';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=8a3fe7a2b2'));
