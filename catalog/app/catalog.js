import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=b7bf85685c';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b7bf85685c';
import { colorSwatches, setBands } from './color-edits.js?v=b7bf85685c';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=b7bf85685c';
import { mountExtractBar, setPageParts } from './extract.js?v=b7bf85685c';
import './bouwstempel.js?v=b7bf85685c';
