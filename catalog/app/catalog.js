import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=1a2d44a0f4';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=1a2d44a0f4';
import { colorSwatches, setBands } from './color-edits.js?v=1a2d44a0f4';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=1a2d44a0f4';
import { mountExtractBar, setPageParts } from './extract.js?v=1a2d44a0f4';
import './bouwstempel.js?v=1a2d44a0f4';
