import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=7791815ef9';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=7791815ef9';
import { colorSwatches, setBands } from './color-edits.js?v=7791815ef9';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=7791815ef9';
import { mountExtractBar, setPageParts } from './extract.js?v=7791815ef9';
