import { renderTagEditor, effectiveKind } from './tag-edits.js?v=409c29a9bd';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=409c29a9bd';
import { renderCommentBox } from './comments.js?v=409c29a9bd';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=409c29a9bd';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=409c29a9bd'));
