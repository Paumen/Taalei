import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=ab792204a5';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=ab792204a5';
import { colorSwatches, setBands } from './color-edits.js?v=ab792204a5';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=ab792204a5';
import { mountExtractBar, setPageParts } from './extract.js?v=ab792204a5';
import './bouwstempel.js?v=ab792204a5';
