import { pendingCount, clearEdits, allEdits, onChange as onTagEdit } from './tag-edits.js?v=4782ee2fb3';
import { markCount, clearMarks, allMarks, onChange as onMark } from './color-edits.js?v=4782ee2fb3';
import { commentCount, clearComments, allComments, allViews, onChange as onComment } from './comments.js?v=4782ee2fb3';
