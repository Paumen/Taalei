import { renderTagEditor, effectiveKind } from './tag-edits.js?v=6f378e90db';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=6f378e90db';
import { renderCommentBox } from './comments.js?v=6f378e90db';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=6f378e90db';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=6f378e90db'));
