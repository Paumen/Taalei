import { renderTagEditor, effectiveKind } from './tag-edits.js?v=af4b6c9551';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=af4b6c9551';
import { renderCommentBox } from './comments.js?v=af4b6c9551';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=af4b6c9551';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=af4b6c9551'));
