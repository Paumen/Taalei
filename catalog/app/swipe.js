import { renderTagEditor, effectiveKind } from './tag-edits.js?v=073931c989';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=073931c989';
import { renderCommentBox } from './comments.js?v=073931c989';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=073931c989';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=073931c989'));
