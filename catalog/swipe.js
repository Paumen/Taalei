import { renderTagEditor, effectiveKind } from './tag-edits.js?v=225ce20976';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=225ce20976';
import { renderCommentBox } from './comments.js?v=225ce20976';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=225ce20976';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=225ce20976'));
