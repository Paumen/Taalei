import { renderTagEditor, effectiveKind } from './tag-edits.js?v=1b7903b37d';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=1b7903b37d';
import { renderCommentBox } from './comments.js?v=1b7903b37d';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=1b7903b37d';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=1b7903b37d'));
