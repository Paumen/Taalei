...
export const GROUPS = [
  ...
  { id: 'grass', name: 'Grass', short: 'Grass', color: '#8fbf5c',
    tab: 'nature',
    description: 'Loose grass and grass clumps: the eight forest-kit grass models and four of their single-sided versions, the five grass clumps from natuur, and the four grass-clump props from the modular-terrain kit.' },
