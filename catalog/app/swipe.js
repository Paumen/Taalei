import { renderTagEditor, effectiveKind } from './tag-edits.js?v=0740602509';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=0740602509';
import { renderCommentBox } from './comments.js?v=0740602509';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=0740602509';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=0740602509'));
