import { renderTagEditor, effectiveKind } from './tag-edits.js?v=1d4878c8b7';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=1d4878c8b7';
import { renderCommentBox } from './comments.js?v=1d4878c8b7';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=1d4878c8b7';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=1d4878c8b7'));
