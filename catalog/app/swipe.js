import { renderTagEditor, effectiveKind } from './tag-edits.js?v=facf4c777f';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=facf4c777f';
import { renderCommentBox } from './comments.js?v=facf4c777f';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=facf4c777f';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=facf4c777f'));
