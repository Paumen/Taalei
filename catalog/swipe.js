import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b9cb0aa6c0';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b9cb0aa6c0';
import { renderCommentBox } from './comments.js?v=b9cb0aa6c0';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b9cb0aa6c0';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b9cb0aa6c0'));
