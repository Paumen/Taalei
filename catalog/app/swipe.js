import { renderTagEditor, effectiveKind } from './tag-edits.js?v=79702b8b67';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=79702b8b67';
import { renderCommentBox } from './comments.js?v=79702b8b67';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=79702b8b67';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=79702b8b67'));
