import { renderTagEditor, effectiveKind } from './tag-edits.js?v=2a22869db7';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=2a22869db7';
import { renderCommentBox } from './comments.js?v=2a22869db7';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=2a22869db7';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=2a22869db7'));
