import { renderTagEditor, effectiveKind } from './tag-edits.js?v=127447474e';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=127447474e';
import { renderCommentBox } from './comments.js?v=127447474e';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=127447474e';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=127447474e'));
