import { renderTagEditor, effectiveKind } from './tag-edits.js?v=440f94df1d';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=440f94df1d';
import { renderCommentBox } from './comments.js?v=440f94df1d';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=440f94df1d';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=440f94df1d'));
