// Onderdelen van een model en hoe dik ze zijn.
//
...
// vlakken in.
//
// Gebruikt door tools/dunste-delen.mjs (meten) en tools/verdik-steel.mjs
// (bijwerken).
...
export function wereldMesh(glb) {
  const { json } = glb;
...
export function onderdelen({ punten, driehoeken }) {
...
export function dikte(groep, punten) {
