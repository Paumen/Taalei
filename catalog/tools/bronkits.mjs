export const BRONKITS = [
  ...
  { map: 'Free_Mushroom_Pack_AssetQuest', naam: 'Free Mushroom Pack', kit: 'aq-mushroom', source: 'aq', formaat: 'fbx' },
  { map: 'Halloween_Kit_AssetQuest', naam: 'Halloween Kit', kit: 'aq-hallow', source: 'aq', formaat: 'fbx' },
  { map: 'Free_Pond_Kit_AssetQuest', naam: 'Free Pond Kit', kit: 'aq-pond', source: 'aq', formaat: 'fbx' },
];
