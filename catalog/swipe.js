import { renderTagEditor, effectiveKind } from './tag-edits.js?v=59cd6db1ce';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=59cd6db1ce';
import { renderCommentBox } from './comments.js?v=59cd6db1ce';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=59cd6db1ce';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=59cd6db1ce'));
