import { pendingCount, clearEdits, allEdits, onChange as onTagEdit } from './tag-edits.js?v=ab792204a5';
import { markCount, clearMarks, allMarks, onChange as onMark } from './color-edits.js?v=ab792204a5';
import { commentCount, clearComments, allComments, allViews, onChange as onComment } from './comments.js?v=ab792204a5';
