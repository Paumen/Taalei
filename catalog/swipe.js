import { renderTagEditor, effectiveKind } from './tag-edits.js?v=97259f493b';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=97259f493b';
import { renderCommentBox } from './comments.js?v=97259f493b';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=97259f493b';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=97259f493b'));
