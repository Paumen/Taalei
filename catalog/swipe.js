import { renderTagEditor, effectiveKind } from './tag-edits.js?v=f4e60c8905';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=f4e60c8905';
import { renderCommentBox } from './comments.js?v=f4e60c8905';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=f4e60c8905';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=f4e60c8905'));
