import { renderTagEditor, effectiveKind } from './tag-edits.js?v=75ec2aa50b';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=75ec2aa50b';
import { renderCommentBox } from './comments.js?v=75ec2aa50b';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=75ec2aa50b';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=75ec2aa50b'));
