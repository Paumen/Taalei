...
const MODELLEN = [
  ...
  ['BirchTree_Dead_Snow_1',  'tree-birch-dead-snow-1'],
  ['BirchTree_Dead_Snow_2',  'tree-birch-dead-snow-2'],
  ...
  ['CommonTree_Dead_Snow_1', 'tree-common-dead-snow-1'],
  ['CommonTree_Dead_Snow_2', 'tree-common-dead-snow-2'],
  ['CommonTree_Dead_Snow_3', 'tree-common-dead-snow-3'],
  ['CommonTree_Dead_Snow_4', 'tree-common-dead-snow-4'],
  ['CommonTree_Dead_Snow_5', 'tree-common-dead-snow-5'],
  ['Corn_1',                 'corn-1'],
  ['Corn_2',                 'corn-2'],
  ['Grass',                  'grass'],
  ['Grass_2',                'grass-2'],
