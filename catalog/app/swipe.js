import { renderTagEditor, effectiveKind } from './tag-edits.js?v=32123776ef';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=32123776ef';
import { renderCommentBox } from './comments.js?v=32123776ef';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=32123776ef';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=32123776ef'));
