import { renderTagEditor, effectiveKind } from './tag-edits.js?v=540f2edd27';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=540f2edd27';
import { renderCommentBox } from './comments.js?v=540f2edd27';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=540f2edd27';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=540f2edd27'));
