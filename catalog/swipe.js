import { renderTagEditor, effectiveKind } from './tag-edits.js?v=677ed9bd98';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=677ed9bd98';
import { renderCommentBox } from './comments.js?v=677ed9bd98';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=677ed9bd98';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=677ed9bd98'));
