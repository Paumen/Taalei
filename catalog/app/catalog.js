import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=192aa3d259';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=192aa3d259';
import { colorSwatches, setBands } from './color-edits.js?v=192aa3d259';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=192aa3d259';
import { mountExtractBar, setPageParts } from './extract.js?v=192aa3d259';
import './bouwstempel.js?v=192aa3d259';
