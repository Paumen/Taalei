import { renderTagEditor, effectiveKind } from './tag-edits.js?v=81ced1955c';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=81ced1955c';
import { renderCommentBox } from './comments.js?v=81ced1955c';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=81ced1955c';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=81ced1955c'));
