import { pendingCount, clearEdits, allEdits, onChange as onTagEdit } from './tag-edits.js?v=2ca2e226dc';
import { markCount, clearMarks, allMarks, onChange as onMark } from './color-edits.js?v=2ca2e226dc';
import { commentCount, clearComments, allComments, allViews, onChange as onComment } from './comments.js?v=2ca2e226dc';
