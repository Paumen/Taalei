export const GROUPS = [
  ...
  { id: 'ocean', name: 'Ocean', short: 'Ocean', color: '#3e8fd0',
    tab: 'nature',
    description: 'What lives in the sea and what washes up from it: the dolphin, whale, shark, manta ray and the three fish from Quaternius, the mackerel and tuna from the pirate kit, the two fish bones, and a shell and a starfish from the beach. Lives in the Nature tab with the seabed, the rocks and the trees — a fish is there without anyone having put it there. The rest of the shells and starfish stay under the seabed with the coral and the seaweed.' },
...
const exceptions = {
  ...
  'natuur/starfish-bleached': 'ocean',
  'natuur/starfish-salmon': 'seabed',
  // Eén schelp en één zeester per kit verhuizen mee naar de oceaan; de rest blijft
  // bij het koraal en het zeewier op de zeebodem.
  'natuur/shell-salmon': 'ocean',
  'modulair-terrein/beach-prop-shell-b': 'ocean',
  'modulair-terrein/beach-prop-starfish-a': 'ocean',
