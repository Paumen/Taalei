import { renderTagEditor, effectiveKind } from './tag-edits.js?v=d80afea962';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=d80afea962';
import { renderCommentBox } from './comments.js?v=d80afea962';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=d80afea962';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=d80afea962'));
