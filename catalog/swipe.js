import { renderTagEditor, effectiveKind } from './tag-edits.js?v=222898f13a';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=222898f13a';
import { renderCommentBox } from './comments.js?v=222898f13a';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=222898f13a';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=222898f13a'));
