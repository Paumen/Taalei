import { renderTagEditor, effectiveKind } from './tag-edits.js?v=fdf054a0ef';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=fdf054a0ef';
import { renderCommentBox } from './comments.js?v=fdf054a0ef';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=fdf054a0ef';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=fdf054a0ef'));
