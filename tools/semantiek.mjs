...
export const GROEPEN = [
  ...
  { id: 'opslag', naam: 'Kisten, vaten & grondstoffen', kort: 'Kisten', kleur: '#dd9f79',
    beschrijving: 'Containers en grondstoffen; goed inzetbaar als beloning of verzamelplek. De resources-kit zit er helemaal in: staven en brokken erts (koper, goud, ijzer, zilver), stenen, hout, textiel, een pallet en een stapel onderdelen.' },
  ...
  { id: 'items', naam: 'Verzamelobjecten & mechaniek', kort: 'Items', kleur: '#f1976c',
    beschrijving: 'Munt, sleutel, ster en hart naast hendel, veer, slot en val: kleine losse objecten die je oppakt of die op een actie reageren. Daar horen de dorpsbel en de twee lampen bij, en de lantaarn en de toorts (gedoofd en brandend) van de rpgtools-kit — geen verzamelobjecten, maar wel klein, los en met een functie. Voorzichtig inzetten, geen punten-economie.' },
...
const regels = [
  ...
  // allebei deze kant op.
  [/^(coin|key|star|heart|lever|spring|trap|lock)$|^(bell|lamp|lantern|torch)\b/, 'items'],
...
const WOORDENBOEK = {
  ...
  banner: ['banier', 'vaandel'], bare: ['kaal', 'dood'], barrel: ['vat', 'ton'],
  ...
  brick: ['baksteen', 'steen'], bridge: ['brug'], broom: ['bezem'], brown: ['bruin'],
  ...
  chest: ['kist', 'schatkist'], chimney: ['schoorsteen'], chisel: ['beitel'],
  ...
  key: ['sleutel'], knife: ['mes'], ladder: ['ladder'], lamp: ['lamp', 'lantaarn'],
  ...
  rounded: ['rond', 'afgerond'], sand: ['zand', 'strand'], saw: ['zaag'],
  ...
  tongs: ['tang'], tool: ['gereedschap'],
  top: ['bovenkant', 'bovenstuk'], torch: ['fakkel', 'toorts'], transition: ['overgang'],
  trap: ['val', 'valluik'],
  tree: ['boom'], trowel: ['troffel'], tuna: ['tonijn', 'vis'], turtle: ['schildpad', 'zeeschildpad'],
