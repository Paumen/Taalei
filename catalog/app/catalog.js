import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=5a608faad2';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=5a608faad2';
import { colorSwatches, setBands } from './color-edits.js?v=5a608faad2';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=5a608faad2';
import { mountExtractBar, setPageParts } from './extract.js?v=5a608faad2';
import './bouwstempel.js?v=5a608faad2';
