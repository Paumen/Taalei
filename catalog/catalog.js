import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=f014adf9ec';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=f014adf9ec';
import { colorSwatches, setBands } from './color-edits.js?v=f014adf9ec';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=f014adf9ec';
import { mountExtractBar, setPageParts } from './extract.js?v=f014adf9ec';
import './bouwstempel.js?v=f014adf9ec';
