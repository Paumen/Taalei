import { renderTagEditor, effectiveKind } from './tag-edits.js?v=d859dfbf38';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=d859dfbf38';
import { renderCommentBox } from './comments.js?v=d859dfbf38';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=d859dfbf38';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=d859dfbf38'));
