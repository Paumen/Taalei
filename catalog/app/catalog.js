import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=e6ce3d8faf';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=e6ce3d8faf';
import { colorSwatches, setBands } from './color-edits.js?v=e6ce3d8faf';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=e6ce3d8faf';
import { mountExtractBar, setPageParts } from './extract.js?v=e6ce3d8faf';
import './bouwstempel.js?v=e6ce3d8faf';
