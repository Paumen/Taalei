import { renderTagEditor, effectiveKind } from './tag-edits.js?v=cd2a3309ab';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=cd2a3309ab';
import { renderCommentBox } from './comments.js?v=cd2a3309ab';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=cd2a3309ab';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=cd2a3309ab'));
