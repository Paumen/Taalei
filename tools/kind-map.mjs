...
const TAG_KIND = {
  ...
  doors: 'str-part-door', floor: 'str-part-floor', roofs: 'str-part-roof',
  window: 'str-part-window', fences: 'str-barrier', stairs: 'str-access-stairs',
...
const GROUP_BRANCH = {
  ...
  'building-kit': 'str-part', structures: 'str', connections: 'str-access', fences: 'str-barrier',
...
const OVERRIDES = {
  ...
  'quat-nature/wheat': 'obj-food-grain',
  'kay-tools/knife': 'obj-tool-hand',
  'kay-tools/axe': 'obj-tool-hand',
  'ken-survival/campfire-stand': 'obj-kitchenware-cookware',
  'ken-survival/campfire-fishing-stand': 'obj-kitchenware-cookware',
  'kay-resources/parts-cog': 'obj-resource',
  'kay-resources/parts-pile-large': 'obj-resource',
  'kay-resources/parts-pile-medium': 'obj-resource',
  'kay-resources/parts-pile-small': 'obj-resource',
  'small-props/skin-hang-a': 'obj-resource',
  'taalei-kit/lighthouse': 'str-part',
  ...
  'kay-dun-1/weapon-rack': 'obj',
  'kay-dun-1/spell-book': 'obj-weapon-magic',
  'ken-pirate/cannon': 'obj-weapon',
  'ken-pirate/cannon-mobile': 'obj-weapon',
  'quat-pirate/cannon': 'obj-weapon',
  'ken-pirate/cannon-ball': 'obj-weapon-ranged-accessory',
  'quat-pirate/cannonball': 'obj-weapon-ranged-accessory',
  'ken-platformer/lock': 'obj',
  'quat-rpg/padlock': 'obj',
  'fs-town/bell-a': 'obj',
  'quat-dun-2/statue-horse': 'obj',
  'quat-dun-2/pedestal-2': 'str-platform',
  'ken-grave/pillar-obelisk': 'str-marker-tombstone',
  'ken-town/blade': 'str-part',
  'fs-town/windmill-blades': 'str-part',
  'ken-forest-mini/building-structure': 'str-part',
  'ken-survival/tent': 'str-part',
  'ken-survival/tent-canvas': 'str-part',
  'ken-survival/tent-canvas-half': 'str-part',
  'fantasy-props/chain-coil': 'obj-tool-supplies',
  'kay-dun-2/floor-tile-small-decorated': 'assy',
  'kay-dun-2/shelves': 'assy',
  'kay-food/food-dinner': 'assy',
  'fs-town/well-plaza': 'assy',
  'kay-hallow/bench-decorated': 'assy',
  'kay-hallow/tree-dead-large-decorated': 'assy',
  'kay-hallow/plaque-candles': 'assy',
  'kay-hallow/shrine-candles': 'assy',
  'kay-hallow/skull-candle': 'assy',
  'kay-hallow/post-lantern': 'assy',
  'kay-hallow/post-skull': 'assy',
  'kay-hallow/post-lantern-lantern': 'obj-lighting-lantern',
  'kay-hallow/post-skull-skull': 'env-remains-bones',
  'kay-dun-2/shelf-small-candles': 'assy',
  'props/plate-food-a': 'obj-food',
  'kay-dun-1/plate-full': 'obj-food',
  'kay-dun-1/plate-half': 'obj-food',
  'quat-food/fish-bone': 'env-remains-bones',
  'quat-food/fish': 'obj-food',
  'small-props/dried-fish-1-a': 'obj-food',
  'ken-pirate/tool-paddle': 'obj-transport-accessory',
  'small-props/wheel-a': 'obj-transport-accessory',
  'ken-town/wheel': 'obj-transport-accessory',
  'small-props/boat-frame-a': 'obj-transport-boat',
  'natuur/campfire-star': 'obj-lighting',
  'natuur/campfire-teepee': 'obj-lighting',
  'fs-terrain/hilly-prop-camp-campfire': 'obj-lighting',
  'fs-terrain/hilly-prop-camp-wood-pile': 'env-flora-deadwood-branch',
  'small-props/fireplace-1-1-a': 'str',
  'fs-town/well-base-cobblestone': 'str',
  'fs-town/well-base-dirt': 'str',
  'fs-town/well-base-grass': 'str',
  'fs-town/well-inside': 'str',
  'ken-cave/template-floor-layer': 'str-part-floor',
  'ken-cave/template-floor-layer-hole': 'str-part-floor',
  'ken-cave/template-floor-layer-raised': 'str-part-floor',
  'ken-pirate/hole': 'str-part-floor',
  'quat-dun-2/cobweb': 'env',
  'quat-dun-2/cobweb-2': 'env',
  'kay-dun-1/artifact': 'obj-pocketitem',
  'quat-pirate/chest-gold': 'assy',
  'quat-dun-2/chest-gold': 'assy',
  'kay-dun-2/chest-gold': 'assy',
  'quat-pirate/gold-bag': 'obj-container-bag',
  'ken-pirate/patch-sand-foliage': 'env-terrain-ground',
  'ken-pirate/patch-grass-foliage': 'env-terrain-ground',
  'ken-forest-mini/patch-grass': 'env-terrain-ground',
  'ken-forest-mini/patch-dirt': 'env-terrain-ground',
  'ken-pirate/patch-sand': 'env-terrain-ground',
  'ken-pirate/patch-grass': 'env-terrain-ground',
  'kay-dun-2/wall-cracked': 'str-part-wall',
  'small-props/cut-wood-1-a': 'env-flora-deadwood-branch',
  'ken-survival/resource-planks': 'obj',
  'ken-pirate/platform-planks': 'obj',
  'kay-resources/pallet-wood': 'obj',
  'kay-skeleton/spellbook': 'obj-weapon-magic',
  'kay-adventurers/spellbook-closed': 'obj-weapon-magic',
