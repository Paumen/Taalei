...
export const KIND_COLORS = {
  ...
  'obj-resource': '#4f7d8c',
  'str-part': '#a8762a', 'str-platform': '#877a63', 'str-barrier': '#b08968',
...
export const NAME_KIND = [
  ...
  [w('plate|platter|dish|tray|saucer'), 'obj-kitchenware-tableware-plate'],
  [w('bowl'), 'obj-kitchenware-tableware-bowl'],
  [w('mug|cup|goblet|tankard|teapot|chalice'), 'obj-kitchenware-tableware'],

  [w('jug|pitcher|ewer'), 'obj-container-jug'],
  ...
  [w('pot|planter|vase|urn|amphora|jar'), 'obj-container-pot'],
  ...
  [w('house|tower|hut|tent|awning|canopy|room|cellar|dungeon|crypt|mill|windmill|lighthouse|church|castle|stand|stall|stable|watermill|sawmill|building|structure|balcony|overhang|blade'), 'str-part'],
