import { renderTagEditor, mountEditBar, effectiveKind, effectiveUses, onChange as onTagEdit } from './tag-edits.js?v=47f09ca2e2';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState } from './chiprij.js?v=47f09ca2e2';
