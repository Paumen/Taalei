import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b54d63d9d6';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b54d63d9d6';
import { renderCommentBox } from './comments.js?v=b54d63d9d6';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b54d63d9d6';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b54d63d9d6'));
