import { renderTagEditor, effectiveKind } from './tag-edits.js?v=e2abb5d2d8';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=e2abb5d2d8';
import { renderCommentBox } from './comments.js?v=e2abb5d2d8';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=e2abb5d2d8';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=e2abb5d2d8'));
