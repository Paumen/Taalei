import { renderTagEditor, effectiveKind } from './tag-edits.js?v=d90548a620';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=d90548a620';
import { renderCommentBox } from './comments.js?v=d90548a620';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=d90548a620';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=d90548a620'));
