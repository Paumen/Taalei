export const GROUPS = [
  ...
  { id: 'items', name: 'Collectibles & mechanics', short: 'Items', color: '#f1976c',
    description: 'Coin, key, star and heart alongside lever, spring and lock: small loose objects you pick up or that react to an action. The village bell belongs here too, along with the coins, keys and keyrings from the dungeon kit — not collectibles, but small, loose and with a function. Also the rpgtools kit\'s travel gear lives here: the two maps and the journal, open and closed. Use sparingly, not a points economy.' },
