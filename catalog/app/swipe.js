import { renderTagEditor, effectiveKind } from './tag-edits.js?v=36c3b1d2fd';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=36c3b1d2fd';
import { renderCommentBox } from './comments.js?v=36c3b1d2fd';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=36c3b1d2fd';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=36c3b1d2fd'));
