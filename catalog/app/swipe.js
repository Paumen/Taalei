import { renderTagEditor, effectiveKind } from './tag-edits.js?v=fefbaca585';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=fefbaca585';
import { renderCommentBox } from './comments.js?v=fefbaca585';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=fefbaca585';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=fefbaca585'));
