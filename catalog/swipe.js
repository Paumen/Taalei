import { renderTagEditor, effectiveKind } from './tag-edits.js?v=dae7c6e165';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=dae7c6e165';
import { renderCommentBox } from './comments.js?v=dae7c6e165';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=dae7c6e165';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=dae7c6e165'));
