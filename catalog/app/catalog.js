import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=46caf1ded6';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=46caf1ded6';
import { colorSwatches, setBands } from './color-edits.js?v=46caf1ded6';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=46caf1ded6';
import { mountExtractBar, setPageParts } from './extract.js?v=46caf1ded6';
import './bouwstempel.js?v=46caf1ded6';
