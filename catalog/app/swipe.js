import { renderTagEditor, effectiveKind } from './tag-edits.js?v=15e198b143';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=15e198b143';
import { renderCommentBox } from './comments.js?v=15e198b143';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=15e198b143';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=15e198b143'));
