import { renderTagEditor, effectiveKind } from './tag-edits.js?v=32a0a4fa91';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=32a0a4fa91';
import { renderCommentBox } from './comments.js?v=32a0a4fa91';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=32a0a4fa91';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=32a0a4fa91'));
