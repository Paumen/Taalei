import { renderTagEditor, effectiveKind } from './tag-edits.js?v=a723c1cd0c';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=a723c1cd0c';
import { renderCommentBox } from './comments.js?v=a723c1cd0c';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=a723c1cd0c';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=a723c1cd0c'));
