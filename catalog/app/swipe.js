import { renderTagEditor, effectiveKind } from './tag-edits.js?v=6561a5e435';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=6561a5e435';
import { renderCommentBox } from './comments.js?v=6561a5e435';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=6561a5e435';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=6561a5e435'));
