import { renderTagEditor, effectiveKind } from './tag-edits.js?v=40bce1fc33';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=40bce1fc33';
import { renderCommentBox } from './comments.js?v=40bce1fc33';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=40bce1fc33';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=40bce1fc33'));
