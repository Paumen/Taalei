import { renderTagEditor, effectiveKind } from './tag-edits.js?v=c93beefd2b';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=c93beefd2b';
import { renderCommentBox } from './comments.js?v=c93beefd2b';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=c93beefd2b';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=c93beefd2b'));
