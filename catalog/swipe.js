import { renderTagEditor, effectiveKind } from './tag-edits.js?v=589d430b4d';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=589d430b4d';
import { renderCommentBox } from './comments.js?v=589d430b4d';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=589d430b4d';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=589d430b4d'));
