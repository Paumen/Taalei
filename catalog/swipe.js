import { renderTagEditor, effectiveKind } from './tag-edits.js?v=c80a5cacbb';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=c80a5cacbb';
import { renderCommentBox } from './comments.js?v=c80a5cacbb';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=c80a5cacbb';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=c80a5cacbb'));
