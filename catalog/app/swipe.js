import { renderTagEditor, effectiveKind } from './tag-edits.js?v=54364aac43';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=54364aac43';
import { renderCommentBox } from './comments.js?v=54364aac43';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=54364aac43';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=54364aac43'));
