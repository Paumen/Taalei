import { renderTagEditor, effectiveKind } from './tag-edits.js?v=2d6363ab2b';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=2d6363ab2b';
import { renderCommentBox } from './comments.js?v=2d6363ab2b';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=2d6363ab2b';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=2d6363ab2b'));
