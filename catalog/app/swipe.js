import { renderTagEditor, effectiveKind } from './tag-edits.js?v=60f698b31e';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=60f698b31e';
import { renderCommentBox } from './comments.js?v=60f698b31e';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=60f698b31e';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=60f698b31e'));
