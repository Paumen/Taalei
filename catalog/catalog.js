import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=53f0370288';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=53f0370288';
import { colorSwatches, setBands } from './color-edits.js?v=53f0370288';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=53f0370288';
import { mountExtractBar, setPageParts } from './extract.js?v=53f0370288';
import './bouwstempel.js?v=53f0370288';
