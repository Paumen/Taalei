import { renderTagEditor, effectiveKind } from './tag-edits.js?v=eaa7a98cd0';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=eaa7a98cd0';
import { renderCommentBox } from './comments.js?v=eaa7a98cd0';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=eaa7a98cd0';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=eaa7a98cd0'));
