import { renderTagEditor, effectiveKind } from './tag-edits.js?v=35cf486917';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=35cf486917';
import { renderCommentBox } from './comments.js?v=35cf486917';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=35cf486917';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=35cf486917'));
