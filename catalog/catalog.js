import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=76d5b9ccf5';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=76d5b9ccf5';
import { colorSwatches, setBands } from './color-edits.js?v=76d5b9ccf5';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=76d5b9ccf5';
import { mountExtractBar, setPageParts } from './extract.js?v=76d5b9ccf5';
import './bouwstempel.js?v=76d5b9ccf5';
