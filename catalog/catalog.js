import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=9e888b8bf6';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=9e888b8bf6';
import { colorSwatches, setBands } from './color-edits.js?v=9e888b8bf6';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=9e888b8bf6';
import { mountExtractBar, setPageParts } from './extract.js?v=9e888b8bf6';
