import { renderTagEditor, effectiveKind } from './tag-edits.js?v=21e88f1412';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=21e88f1412';
import { renderCommentBox } from './comments.js?v=21e88f1412';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=21e88f1412';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=21e88f1412'));
