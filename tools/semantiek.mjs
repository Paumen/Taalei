...
const WOORDENBOEK = {
  ...
  gathered: ['opgehoopt', 'hoop'], glass: ['glas', 'loep'], grass: ['gras'],
  ...
  lobster: ['kreeft'], lock: ['slot'], long: ['lang'], low: ['laag', 'lage'],
  ...
  template: ['sjabloon', 'grot'], tent: ['tent'], tongs: ['tang'], tool: ['gereedschap'],
