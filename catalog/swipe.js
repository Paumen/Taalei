import { renderTagEditor, effectiveKind } from './tag-edits.js?v=79ca89f9fb';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=79ca89f9fb';
import { renderCommentBox } from './comments.js?v=79ca89f9fb';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=79ca89f9fb';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=79ca89f9fb'));
