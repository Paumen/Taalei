...
const ASSEMBLIES = new Set([
  ...
  'furniture/book-set', 'furniture/shelf-b-large-decorated',
  'natuur/timber-stack-1', 'natuur/timber-stack-2',
...
const uitzonderingen = {
  ...
  'graveyard-kit/detail-bowl': 'eten',
  'graveyard-kit/detail-chalice': 'eten',
  'graveyard-kit/detail-plate': 'eten',
  'holiday-kit/snowman': 'items',
  'holiday-kit/snowman-hat': 'items',
  'halloween/post-lantern': 'licht',
  'fantasy-props/table-plate': 'eten',
  'restaurant/knife': 'eten',
