import { renderTagEditor, effectiveKind } from './tag-edits.js?v=77ad8b37e1';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=77ad8b37e1';
import { renderCommentBox } from './comments.js?v=77ad8b37e1';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=77ad8b37e1';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=77ad8b37e1'));
