import { renderTagEditor, effectiveKind } from './tag-edits.js?v=cf7be41dc7';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=cf7be41dc7';
import { renderCommentBox } from './comments.js?v=cf7be41dc7';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=cf7be41dc7';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=cf7be41dc7'));
