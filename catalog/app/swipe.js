import { renderTagEditor, effectiveKind } from './tag-edits.js?v=62698f5e6f';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=62698f5e6f';
import { renderCommentBox } from './comments.js?v=62698f5e6f';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=62698f5e6f';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=62698f5e6f'));
