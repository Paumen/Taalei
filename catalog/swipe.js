import { renderTagEditor, effectiveKind } from './tag-edits.js?v=b3b3fcb9a0';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=b3b3fcb9a0';
import { renderCommentBox } from './comments.js?v=b3b3fcb9a0';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=b3b3fcb9a0';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=b3b3fcb9a0'));
