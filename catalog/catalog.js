import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=2d1b067db8';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=2d1b067db8';
import { colorSwatches, setBands } from './color-edits.js?v=2d1b067db8';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=2d1b067db8';
import { mountExtractBar, setPageParts } from './extract.js?v=2d1b067db8';
