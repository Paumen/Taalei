import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=8f3e3be847';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=8f3e3be847';
import { colorSwatches, setBands } from './color-edits.js?v=8f3e3be847';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=8f3e3be847';
import { mountExtractBar, setPageParts } from './extract.js?v=8f3e3be847';
