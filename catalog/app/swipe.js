import { renderTagEditor, effectiveKind } from './tag-edits.js?v=dccca619dc';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=dccca619dc';
import { renderCommentBox } from './comments.js?v=dccca619dc';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=dccca619dc';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=dccca619dc'));
