import { renderTagEditor, effectiveKind } from './tag-edits.js?v=0c8db98b78';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=0c8db98b78';
import { renderCommentBox } from './comments.js?v=0c8db98b78';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=0c8db98b78';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=0c8db98b78'));
