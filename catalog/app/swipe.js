import { renderTagEditor, effectiveKind } from './tag-edits.js?v=bc758eec71';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=bc758eec71';
import { renderCommentBox } from './comments.js?v=bc758eec71';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=bc758eec71';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=bc758eec71'));
