...
export const GROUPS = [
  ...
  { id: 'items', name: 'Collectibles & mechanics', short: 'Items', color: '#f1976c',
    description: 'Star and heart alongside lever, spring and cobweb: small loose objects you pick up or that react to an action. The village bell belongs here too, and so do the journals and maps. The backpack and the bags went to chests and barrels, the coins, rings and necklaces moved to coins & jewellery, the keys, keyrings and locks to keys & locks, and the bones and skulls to bones. Use sparingly, not a points economy.' },
