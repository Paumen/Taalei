import { renderTagEditor, effectiveKind } from './tag-edits.js?v=2c07411020';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=2c07411020';
import { renderCommentBox } from './comments.js?v=2c07411020';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=2c07411020';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=2c07411020'));
