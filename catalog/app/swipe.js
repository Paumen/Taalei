import { renderTagEditor, effectiveKind } from './tag-edits.js?v=a9512cab91';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=a9512cab91';
import { renderCommentBox } from './comments.js?v=a9512cab91';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=a9512cab91';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=a9512cab91'));
