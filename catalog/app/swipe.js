import { renderTagEditor, effectiveKind } from './tag-edits.js?v=219e614d3f';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=219e614d3f';
import { renderCommentBox } from './comments.js?v=219e614d3f';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=219e614d3f';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=219e614d3f'));
