import { renderTagEditor, effectiveKind } from './tag-edits.js?v=6b314c9e79';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=6b314c9e79';
import { renderCommentBox } from './comments.js?v=6b314c9e79';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=6b314c9e79';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=6b314c9e79'));
