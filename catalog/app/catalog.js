import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=94f246bd15';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=94f246bd15';
import { colorSwatches, setBands } from './color-edits.js?v=94f246bd15';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=94f246bd15';
import { mountExtractBar, setPageParts } from './extract.js?v=94f246bd15';
import './bouwstempel.js?v=94f246bd15';
