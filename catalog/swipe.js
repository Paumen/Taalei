import { renderTagEditor, effectiveKind } from './tag-edits.js?v=f90804f630';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=f90804f630';
import { renderCommentBox } from './comments.js?v=f90804f630';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=f90804f630';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=f90804f630'));
