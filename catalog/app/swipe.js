import { renderTagEditor, effectiveKind } from './tag-edits.js?v=945a259b44';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=945a259b44';
import { renderCommentBox } from './comments.js?v=945a259b44';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=945a259b44';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=945a259b44'));
