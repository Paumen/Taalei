import { renderTagEditor, effectiveKind } from './tag-edits.js?v=cd267bd4f2';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=cd267bd4f2';
import { renderCommentBox } from './comments.js?v=cd267bd4f2';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=cd267bd4f2';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=cd267bd4f2'));
