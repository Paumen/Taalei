import { renderTagEditor, effectiveKind } from './tag-edits.js?v=19ee4cdb39';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=19ee4cdb39';
import { renderCommentBox } from './comments.js?v=19ee4cdb39';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=19ee4cdb39';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=19ee4cdb39'));
