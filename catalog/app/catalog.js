import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=0ed36c3988';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=0ed36c3988';
import { colorSwatches, setBands } from './color-edits.js?v=0ed36c3988';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=0ed36c3988';
import { mountExtractBar, setPageParts } from './extract.js?v=0ed36c3988';
import './bouwstempel.js?v=0ed36c3988';
