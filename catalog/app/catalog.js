import { renderTagEditor, effectiveKind, onChange as onTagEdit } from './tag-edits.js?v=cd267bd4f2';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=cd267bd4f2';
import { colorSwatches, setBands } from './color-edits.js?v=cd267bd4f2';
import { renderCommentBox, hasComment, onChange as onComment } from './comments.js?v=cd267bd4f2';
import { mountExtractBar, setPageParts } from './extract.js?v=cd267bd4f2';
import './bouwstempel.js?v=cd267bd4f2';
