import { renderTagEditor, effectiveKind } from './tag-edits.js?v=ed26319a00';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=ed26319a00';
import { renderCommentBox } from './comments.js?v=ed26319a00';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=ed26319a00';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=ed26319a00'));
