import { renderTagEditor, effectiveKind } from './tag-edits.js?v=362178b777';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=362178b777';
import { renderCommentBox } from './comments.js?v=362178b777';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=362178b777';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=362178b777'));
