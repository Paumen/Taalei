import { renderTagEditor, effectiveKind } from './tag-edits.js?v=7787dc5bca';
import { makeChipStrip, layoutChips, syncChips, showChipState as showState, chipName } from './chiprij.js?v=7787dc5bca';
import { renderCommentBox } from './comments.js?v=7787dc5bca';
import { mountExtractBar, setPageParts, downloadExtract } from './extract.js?v=7787dc5bca';
...
async function drawScaleCard(model, canvas) {
  if (!drawAtScale) ({ drawFamily: drawAtScale } = await import('./scale-draw.js?v=7787dc5bca'));
